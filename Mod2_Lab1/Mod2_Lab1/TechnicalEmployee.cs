...
namespace Mod2_Lab1
{
    class TechnicalEmployee : Employee
    {
        ...
        //This methods returns the toString() method - which is the employee's ID number and name - and prints the number of successful check ins the employee has had
